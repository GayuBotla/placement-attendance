    ...
    if (isset($_POST['Change'])) {
        ...
        $date = mysqli_real_escape_string($con,$_POST['date'])." ".mysqli_real_escape_string($con,$_POST['time']);
        $query="UPDATE student set attended_status='1',attended_on='".$date."' where cmpny_id='".$cmpny_id."' and rollno='".$rollno."'";
                ...
                <div class="table table-responsive" style="margin-top:0;">
                    <table class="table-striped  table-hover table-condensed table-bordered" id="example1">
                        ...
                        <tbody>
                            ...
                            @$cmpny_id=mysqli_real_escape_string($con,$_GET['id']);
                            if(@$cmpny_id!=""){
                                $result=mysqli_query($con,"SELECT * from student where cmpny_id='".$cmpny_id."' and attended_status='0' ");
                            }
                            else{
                                $result=mysqli_query($con,"SELECT * from student where attended_status='0' ");
                            }
                            $i=1;
